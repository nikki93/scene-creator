...
function Client:moveActorForward(actorId, command)
    ...
    if actor.drawOrder < table.maxn(self.actorsByDrawOrder) then
        ...
        if fixture then
            local newDrawOrder
            local hits = self.behaviorsByName.Body:getActorsAtBoundingBox(fixture:getBoundingBox())
            for hit in pairs(hits) do -- Find greatest draw order below us
                local otherActor = self.actors[hit]
                if
                    (otherActor.drawOrder > actor.drawOrder and
                        (not newDrawOrder or otherActor.drawOrder < newDrawOrder))
                 then
    ...
    ui.scrollBox(
        ...
        function()
            ...
            if actorId then
                ...
                ui.box(
                    "properties-" .. actor.actorId .. "-" .. (self.updateCounts[actorId] or 1),
                    function()
                        -- Sort by `behaviorId`
                        local order = {}
                        for behaviorId, component in pairs(actor.components) do
                                                            ...
                                                            self:uiLibrary(
                                                                {
                                                                    ...
                                                                    filterBehavior = function(behavior)
                                                                        ...
                                                                        if
                                                                            (actor.components[
                                                                                self.behaviorsByName.Body.behaviorId
                                                                            ] and behavior == self.behaviorsByName.Text)
                                                                         then
                                                                            return false
                                                                        end
                                                                        ...
                                                                        if
                                                                            (actor.components[
                                                                                self.behaviorsByName.Text.behaviorId
                                                                            ] and behavior ~= self.behaviorsByName.Rules)
                                                                         then
                                                                            return false
                                                                        end

                                                                        -- Skip behaviors we already have, skip tools
                                                                        return not (actor.components[behavior.behaviorId] or
                                                                            behavior.tool)
                                                                    end,
                                                                ...
                                                                onOk = function()
                                                                    ...
                                                                    self:command(
                                                                        ...
                                                                        function()
                                                                            ...
                                                                            self.updateCounts[actorId] =
                                                                                (self.updateCounts[actorId] or 1) + 1
                                                                        end,
                                                                        function()
                                                                            local behavior = self.behaviors[behaviorId]
                                ...
                                popover = function(closePopover)
                                    ui.scrollBox(
                                        ...
                                        function()
                                            ...
                                            saveBlueprintData.description =
                                                ui.textArea("description", saveBlueprintData.description)
                                            ...
                                            if existingEntry then
                                                ...
                                                for otherActorId, otherActor in pairs(self.actors) do
                                                    if
                                                        otherActorId ~= actorId and
                                                            otherActor.parentEntryId == existingEntry.entryId
                                                     then
                                                    ...
                                                    "update used blueprint",
                                                    {
                                                        ...
                                                        onClick = function()
                                                            if saveBlueprintData.title == "" then
                                                                castle.system.alert(
                                                                    "Title required",
                                                                    "Please enter a title for the blueprint."
                                                                )
                                                                return
                                                            end
                                                            for entryId, entry in pairs(self.library) do
                                                                if
                                                                    (entry.entryType == "actorBlueprint" and
                                                                        entry.entryId ~= existingEntry.entryId and
                                                                        entry.title == saveBlueprintData.title)
                                                                 then
                                                                    castle.system.alert(
                                                                        "Title in use",
                                                            ...
                                                            if newActorBp.components.Body then
                                                                newActorBp.components.Body.x,
                                                                    newActorBp.components.Body.y = nil, nil
                                                            end
                                                            local newEntry = {
                                                ...
                                                "save as new blueprint",
                                                {
                                                    ...
                                                    onClick = function()
                                                        if saveBlueprintData.title == "" then
                                                            castle.system.alert(
                                                                "Title required",
                                                                "Please enter a title for the new blueprint."
                                                            )
                                                            return
                                                        end
                                                        for entryId, entry in pairs(self.library) do
                                                        ...
                                                        local newActorBp = self:blueprintActor(actor.actorId)
                                                        if newActorBp.components.Body then
                                                            newActorBp.components.Body.x, newActorBp.components.Body.y =
                                                                nil,
                                                                nil
                                                        end
                                                        self:send(
